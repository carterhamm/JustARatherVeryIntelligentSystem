...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed inset-x-0 top-[72px] bottom-[88px] z-20 flex flex-col items-center pointer-events-none">
      {/* Messages area */}
      ...
      {/* Input bar */}
      <div className="w-full max-w-3xl px-5 sm:px-8 pt-2 pointer-events-auto boot-3">
        <GlassInput
          onSend={sendMessage}
