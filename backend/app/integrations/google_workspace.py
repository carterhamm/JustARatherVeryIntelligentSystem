...
async def gmail_important_recent(
    ...
    def _sync() -> list[dict[str, Any]]:
        ...
        results = service.users().messages().list(
            userId="me",
            q="is:inbox newer_than:7d -category:promotions -category:social -category:updates -category:forums -from:noreply -from:no-reply -from:notifications -from:receipts -from:billing -from:support -from:alerts -from:builds",
